...
# Crear handles para la leyenda de las aristas (ahora con el mismo grosor pero diferente color)
...
# --- Cambiar la ubicación de la leyenda a la derecha ---
# bbox_to_anchor=(1.05, 1) y loc='upper left' son para colocarla a la derecha de la figura.
# ncols=1 es para que se muestren en una sola columna.
