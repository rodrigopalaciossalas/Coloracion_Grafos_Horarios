...
with open('asignacion_alumnos(pequeña).json', 'r') as f:
...
try:
    with open('asignacion_profesores(pequeña).json', 'r') as f:
        professor_assignments = json.load(f)
except FileNotFoundError:
    print("Advertencia: 'asignacion_profesores(pequeña).json' no encontrado. Los conflictos de profesores no se considerarán.")
